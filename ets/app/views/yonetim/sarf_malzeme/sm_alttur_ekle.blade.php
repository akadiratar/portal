...
@section('icerik')
      ...
      <div class="breadcrumb-line" style="margin: 0;">
        <ul class="breadcrumb">
          ...
          <li>Sarf Malzeme Alttürü Ekle</li>
        </ul>
      </div>
      <!-- /breadcrumbs line -->
<hr>
...
<form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post" >
  <!-- Basic inputs -->
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title"><i class="icon-bubble4"></i> Sarf Malzeme Alttürü Ekle Formu</h6></div>
        <div class="panel-body">
            ...
            <div class="col-sm-10">
              <select name="sm_tur_id" class="form-control" required>
                  ...
                  @foreach ($sm_turler as $sm_tur)
                    <option value="{{ $sm_tur->id }}">{{ $sm_tur->sm_tur_adi }}</option>
                  @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sm_alttur_adi" class="form-control" value="" required autocomplete="off">
            </div>
          </div>

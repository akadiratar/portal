...
var KTChat = function() {
    ...
    return {
        init: function() {
            t(KTUtil.getByID("kt_chat_modal")), "http://www.istanbulanadolu.adalet.gov.tr/" != encodeURI(window.location.hostname) && "http://www.istanbulanadolu.adalet.gov.tr/" != encodeURI(window.location.hostname) || setTimeout(function() {
    ...
    return {
        init: function() {
            t = KTUtil.getByID("kt_demo_panel"),
                ...
                }(), "http://www.istanbulanadolu.adalet.gov.tr/" != encodeURI(window.location.hostname) && "http://www.istanbulanadolu.adalet.gov.tr/" != encodeURI(window.location.hostname) || setTimeout(function() {

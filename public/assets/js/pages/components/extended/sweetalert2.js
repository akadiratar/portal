...
var KTSweetAlert2Demo = {
    init: function() {
        ...
        }), $("#kt_sweetalert_oda_sayisi").click(function(e) {
            swal.fire("Uyarı!", "Bu seçeneği işaretlerseniz, 1'den yazdığınız oda numarasına kadar olan eksik odaları toplu olarak ekler.", "info")
        ...
        }), $("#kt_sweetalert_rol_kaydet").click(function(e) {
            swal.fire({
                title: "Başarılı!",

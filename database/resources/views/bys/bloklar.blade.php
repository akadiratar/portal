...
@section('breadcrumb')
> <a href="{{ route('bys_bloklar') }}">BLOKLAR</a>
@endsection

@if(auth()->user()->can('bys.yapi_islemleri'))
  @section('sub_header')
  <a href="{{route('bys_blok_ekle')}}" class="btn btn-label-brand btn-bold">
    BLOK EKLE
  </a>
  @endsection
@endif
                      ...
                      <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        <ul class="kt-nav">
                          <li class="kt-nav__item">
                            <a href="{{route('bys_blok_duzenle', $blok->id)}}" class="kt-nav__link">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Blok Sil</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        </button>
                      </div>
                      <div class="modal-body">
                        <p><b>Blok Adı:</b> {{$blok->blok_adi}} BLOK</p>
                        <h4 style="color: red;">Silmek istediğinizden emin misiniz?</h4>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kapat</button>
                        <a href="{{route('bys_blok_sil', $blok->id)}}"  class="btn btn-primary">Sil</a>
                      </div>
                    </div>
                  </div>
                </div>

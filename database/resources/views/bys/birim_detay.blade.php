    ...
    <div class="tab-content">
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6 order-lg-2 order-xl-1">
            <div class="alert alert-dark" role="alert">
              <div class="alert-text"><h4><a style="color: white;" href="{{route('bys_birim_detay', $alt_birim->id)}}">{{$alt_birim->birim_adi}}</a></h4></div>
            </div>
          </div>
          @endforeach
        </div>
      ...
      <div class="tab-pane <?php if(!is_null($odalar) && count($alt_birimler)==0 && count($odalar)>0) { echo 'active'; }?>" id="kt_tabs_1_2" role="tabpanel">
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6 order-lg-2 order-xl-1">
            <div class="alert alert-dark" role="alert">
              <div class="alert-text"><a href="{{route('bys_oda_ara', $oda->oda_kodu)}}"><h4><span style="color: white;" href="">{{$oda->oda_kodu}} >> {{$oda->tip->oda_tipi_adi}}</span></h4></a></div>
            </div>
          </div>
          @endforeach
        </div>
